...
public class UserRepositoryTest {
    ...
    public void test_should_create_user() {
        ...
        UserSearchResponseContent searchContent =
                new UserSearchResponseContent(1L, "test@gmail.com", "123456789", roles);
        ...
        User expectedUser =
                new User(1L, "test@gmail.com", "123456789", roles);
    ...
    public void test_should_notmatch_create_user_And_expecteduser() {
        ...
        User expectedUser =
                new User(2L, "test123@gmail.com", "123456789", roles);
